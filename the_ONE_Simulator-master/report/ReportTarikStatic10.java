 ...
 */
public class ReportTarikStatic10 extends Report implements MessageListener {
...
//        
       ...
       double total=0;
        ...
        for (Map.Entry<String, Tuple<Double, Double>> entry : Incentive.getTime().entrySet()) {
//            cetak+="Pesan : "+entry.getKey();
//            cetak+="\nwaktu start"+entry.getValue().getValue();
//            cetak+="\nwaktu end"+entry.getValue().getKey();
    if(entry.getValue().getValue()!= -1){
            jumlah += entry.getValue().getValue()-entry.getValue().getKey();
            counter++;
        }
        }
        
        total= jumlah/counter;
        cetak += " Rata-rata Waktu Transaksi = " + total;
        cetak+="\n Transaksi Total = "+Incentive.getFinished();
        cetak+="\n Transaksi Berhasil = "+Incentive.getOk();
        cetak+="\n Transaksi Gagal = "+Incentive.getGagal();
        cetak+="\n Presentase Mis Beha berhasil dibayar = "+Incentive.getOk()/Incentive.getFinished()*100;
